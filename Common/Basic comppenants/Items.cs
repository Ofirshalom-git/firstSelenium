...
namespace Common
{
    public class Items : ComppenantBase
    {
        ...
        public List<Button> ViewButtonOfItem => Driver.FindElements(By.CssSelector(".lnk_view.btn.btn-default")).Select(element => new Button(Driver, element)).ToList();
        ...
        public List<ColorRow> OptionalColorsOfItem => Driver.FindElements(By.CssSelector(".color_to_pick_list.clearfix")).Select(element => new ColorRow(Driver, element)).ToList();
